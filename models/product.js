...
module.exports.getProductById = function(id , callback){
    var sql = `SELECT product_id as id, product_title as title, product_image as image, cate_title as category, product_origin as origin, product_old_price as old_price, product_price as price, product_tag as tags, product_desc as description, brand_name as brand, product_quantity as stock, collection
    FROM product a join category b on a.product_category = b.cate_id join brand c on a.product_brand = c.brand_id WHERE product_id = ${id}`
    db.connectDB(function (err, connect){
        if (err) callback(err, null)
        else {
            connect.query(sql, callback);
...
module.exports.getProductByCategoryId = function(id, callback){
    var sql = `SELECT product_id as id, product_title as title, product_image as image, cate_title as category, product_origin as origin, product_old_price as old_price, product_price as price, product_tag as tags, product_desc as description, brand_name as brand, product_quantity as stock, collection
    FROM product a join category b on a.product_category = b.cate_id join brand c on a.product_brand = c.brand_id WHERE product_category = ${id}`
    db.connectDB(function (err, connect){
        if (err) callback(err, null)
        else {
            connect.query(sql, callback);
...
module.exports.getProductByBrandId = function(id, callback){
    var sql = `SELECT product_id as id, product_title as title, product_image as image, cate_title as category, product_origin as origin, product_old_price as old_price, product_price as price, product_tag as tags, product_desc as description, brand_name as brand, product_quantity as stock, collection
    FROM product a join category b on a.product_category = b.cate_id join brand c on a.product_brand = c.brand_id WHERE product_brand = ${id}`
    db.connectDB(function (err, connect){
        if (err) callback(err, null)
        else {
            connect.query(sql, callback);
...
module.exports.getProductByOriginId = function(id, callback){
    var sql = `SELECT product_id as id, product_title as title, product_image as image, cate_title as category, product_origin as origin, product_old_price as old_price, product_price as price, product_tag as tags, product_desc as description, brand_name as brand, product_quantity as stock, collection
    FROM product a join category b on a.product_category = b.cate_id join brand c on a.product_brand = c.brand_id WHERE product_origin = ${id}`
    db.connectDB(function (err, connect){
        if (err) callback(err, null)
        else {
            connect.query(sql, callback);
